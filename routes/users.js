...
router.route('/radius/:zipcode/:distance').get(getUsersByRadius)

router.route('/:id/photo').put(protect, userPhotoUpload)

router.route('/:id/files').get(protect, getAllFiles)

router.route('/:id/files/:album').get(protect, getAllFiles)
